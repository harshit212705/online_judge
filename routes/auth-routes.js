...
passport.use(new GitHubStrategy({
    clientID: "",        //<------- PASTE YOUR GITHUB CLIENT_ID HERE
    clientSecret: '',    //<------- PASTE YOUR GITHUB CLIENT_SECRET HERE   
    callbackURL: "http://localhost:3000/auth/github/redirect"   //ONLY MENTION THIS REDIRECT URL WHILE CREATING THE CLIENT_ID 
  },
